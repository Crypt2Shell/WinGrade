...
function banner {
    ...
    try{$ipAddresses = ($network | where IPAddress |% { $_.IPAddress[0] }) -join ", "}Catch{}
      ...
      write-host "      :::::::::::::::." -ForegroundColor Red -NoNewline;write-host " .:::::::::::::::" -ForegroundColor Green -NoNewline;try{write-host "     Kernel:            " -ForegroundColor Gray -NoNewline;write-host "Version: $((try{Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\" -Name ReleaseID).ReleaseId}Catch{}) (Build: $($os.Version))" -ForegroundColor White -ErrorAction SilentlyContinue}Catch{}
     write-host "     .:::::::::::::::" -ForegroundColor Red -NoNewline;write-host "  :::::::::::::::." -ForegroundColor Green 
...
function get-reboot {
	...
	echo "@echo off" > "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\WinGrade.bat"
	...
	Restart-Computer -Force
        ...
        del "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\WinGrade.bat"|out-null
        elevate-privileges
    }
}
elevate-privileges
